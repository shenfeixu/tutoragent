...
echo "=================================================="
echo "  TutorAgent v1.31 - 部署开始"
echo "  商业计划书自动合成 (v1.31) + 199案例知识图谱"
echo "=================================================="
...
if fuser $PORT/tcp >/dev/null 2>&1; then
    echo ""
    echo "=================================================="
    echo "  DONE! v1.31 部署成功"
    echo "  访问地址: http://$(hostname -I | awk '{print $1}'):$PORT"
    echo "  日志文件: server_v1.31.log"
    echo "=================================================="
else
    echo ""
    echo "  ERROR: 启动失败，请检查日志:"
    echo "  tail -f server_v1.31.log"
fi
